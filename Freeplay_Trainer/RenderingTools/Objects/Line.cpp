...
void RT::Line::DrawWithinFrustum(CanvasWrapper canvas, Frustum& frustum) const {
	DrawWithinFrustum(canvas, frustum, LinearColor(0.0, 0.0, 0.0, 255.0));
}

void RT::Line::DrawWithinFrustum(CanvasWrapper canvas, Frustum &frustum, LinearColor color) const
{
